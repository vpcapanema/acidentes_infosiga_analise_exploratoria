...
<footer>
  ...
  <div style="margin-top:6px;color:#94a3b8;font-size:.85em">© 2026 VPC-GEOSER — Análise exploratória do Infosiga SP, período 2014–2026 · Atualizado em {pd.Timestamp.now().strftime('%d/%m/%Y %H:%M')}</div>
</footer>
"""
